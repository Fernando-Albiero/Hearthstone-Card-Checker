...
## Deploy
The app's backend was deployed using Render - https://render.com.

**OBS:** The first app's request can take a while because render sleeps when inactive.
...
To run this project directly on emulator, you should download and install the emulator of your preference or use an online emulator. After that, just download the app avaiable on shields below and install it on the emulator (drag and drop). If you are using Android, there is no need of emulator, you can download and install the app directly on your real device.
